...
#    'python main.py training_forsee dataset/java40 java40 --k=10 --device=gpu',
    'python main.py training_forsee dataset/my_verification_dataset_2000 my_verification_dataset_2000 --k=10 --device=gpu'
    ]
